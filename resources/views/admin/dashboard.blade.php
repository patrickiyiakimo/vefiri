        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <a href="{{ route('admin.orders.index') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-lg font-semibold text-gray-900">Manage Orders</p>
                        <p class="text-sm text-gray-500">View and update orders</p>
                    </div>
                </div>
            </a>
            
            <a href="{{ route('admin.vendors.pending') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
                <div class="flex items-center">
                    <div class="p-3 bg-green-100 rounded-full">
                        <svg class="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="ml-4">
                        <p class="text-lg font-semibold text-gray-900">Vendor Applications</p>
                        <p class="text-sm text-gray-500">{{ $pendingVendorsCount ?? 0 }} pending approvals</p>
                    </div>
                </div>
            </a>
            
            <a href="{{ route('admin.logistics.index') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-lg font-semibold text-gray-900">Logistics</p>
                        <p class="text-sm text-gray-500">{{ $pendingLogisticsCount ?? 0 }} pending approvals</p>
                    </div>
                </div>
            </a>
        </div>
