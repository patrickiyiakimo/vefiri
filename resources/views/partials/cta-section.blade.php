    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div class="text-center mb-20">
            <div class="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full mb-6 border border-white/20">
                ...
                <span class="text-orange-400 text-sm font-medium">Your Journey Starts Here</span>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div class="group bg-white/10 backdrop-blur-md rounded-2xl overflow-hidden border border-white/20 hover:border-orange-500/50 transition-all duration-300 hover:shadow-2xl">
                <div class="relative p-8 md:p-10">
                    ...
                    <!-- CTA Button -->
                    <a href="{{ route('shop') }}" 
                       class="group/btn w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold rounded-xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    @auth
                        @if(auth()->user()->isVendor())
                            <a href="{{ route('vendor.dashboard') }}" 
                               class="group/btn w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold rounded-xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
