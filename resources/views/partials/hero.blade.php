<!-- Hero Section with Background Video - Responsive Height Control -->
<section class="relative overflow-hidden">
    ...
    <!-- Content with Responsive Height Constraints -->
    <div class="relative z-20 flex flex-col items-center justify-center px-4 sm:px-6 py-12">
        <!-- Responsive Container: Mobile shorter, laptop full, ultrawide constrained -->
        <div class="mx-auto w-full">
            ...
            <div class="text-center mx-auto 
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-5 justify-center mb-12 sm:mb-16 px-4 sm:px-0">
                    ...
                    @else
                        <a href="{{ route('signup') }}" 
                           class="group inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semiboldhover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 text-base sm:text-lg">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2 group-hover:animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path>
                            </svg>
                            Get Started
...
<style>
    ...
    /* Mobile: shorter height - not full screen */
    ...
    /* Ultrawide screens (1920px and above): shorter, not full height */
    ...
    /* Extra ultrawide (2560px+): even shorter */
