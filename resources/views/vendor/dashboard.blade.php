        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
                    ...
                    <div class="p-6 hover:bg-gray-50">
                        <div class="flex justify-between items-center">
                            ...
                            <div class="flex space-x-3">
                                ...
                                <button class="px-3 py-1 bg-red-600 text-white rounded hover:bg-red-700 transition text-sm">
                                    Delete
                                </button>
                            </div>
                        </div>
            ...
            @else
                <div class="p-6 text-center text-gray-500">
                    ...
                    <a href="{{ route('vendor.products.create') }}" class="text-orange-600 hover:underline">Add your first product</a>
                </div>
            @endif
        </div>
    </div>
